...
assert.equal(Engine.classifyActionText("Continue shopping").eligible, false);
assert.equal(Engine.classifyActionText("Alışverişe devam et").eligible, false);
assert.equal(Engine.classifyActionText("Continue reading").eligible, false);
...
assert.equal(Engine.classifyActionText("Please disable Adblock to continue").eligible, false);
assert.equal(Engine.classifyActionText("Please disable Adblock to continue").reason, "Reklam engeli kilidi");
